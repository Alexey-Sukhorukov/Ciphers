...
inp = list(input('Введите сообщения для дешифрования: '))
# inp = list('крипто')
# KEY
key = list(input('Введите ключ для дешифрования: '))
print()
# key = list('KEY')
...
print('Буква закрытого текста:    ', *inp, sep='\t')
...
print('Результат декодирования:    ', *cipher, sep='')
